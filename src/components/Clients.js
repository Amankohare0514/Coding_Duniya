    ...
    <div className="bg-[#2c55eaf6]">
      ...
      <div className=" px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl space-y-16 lg:space-y-0 lg:flex lg:space-x-8">
          <Card className="flex flex-col items-center bg-[#2c55eaf6] hover:border p-8 text-center shadow-lg">
           ...
           <FormatQuoteIcon className="text-white"/>
            ...
            <figcaption className="mt-6">
              <div className="text-lg font-medium text-gray-300">Aman</div>
            </figcaption>
          </Card>
          <Card className="flex flex-col items-center bg-[#2c55eaf6] hover:border  p-8 text-center shadow-lg">
            <blockquote className="relative flex-1">
            ...
            <figcaption className="mt-6">
              <div className="text-lg font-medium text-gray-300">Piyush</div>
            </figcaption>
          </Card>
          <Card className="flex flex-col items-center bg-[#2c55eaf6]  hover:border p-8 text-center shadow-lg">
            <blockquote className="relative flex-1">
            ...
            <figcaption className="mt-6">
              <div className="text-lg font-medium text-gray-300">Ratnesh</div>
            </figcaption>
          </Card>
        </div>
      </div>
